...
注意：gitbook install 是<font color='red'>增量安装。</font>   已经安装了的plugin，不会重新安装！！！
...
用 node_modules_2024-12-29.zip 来还原 node_modules时，<font color='red'>注意把   node_modules 所有东西删掉，直接覆盖不行，有.bin文件！！！！！！</font>

>   ![image-20241229144556762](software_pcSettings.assets/image-20241229144556762.png)
...
/* 修改可读行长度的宽度数值 */
body {
  --file-line-width: 1000px; /* 这里可以根据你的显示器改成 1000px, 1200px 等 */
}
```
