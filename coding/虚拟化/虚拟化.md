...
https://www.bilibili.com/video/BV1b64y1a7wL/?spm_id_from=333.337.search-card.all.click  虚拟化系列课程

# 实例1 --------B的虚拟化

虚拟化的本质：两个系统<font color='red'>共用的资源都必然涉及到虚拟化</font>
...
​            GPU，只有一个－－－> 虚拟化: 在用户态的虚拟化（top能看到这个进程）

​           磁盘呢？

​           display的虚拟化：plane是物理的，不存虚拟化。但是屏幕资源只有一个

​          touch资源，也只有一个，必然也存在touch的虚拟化（虚拟化给安卓）
