...
> <font color='red'>一切优化，都是资源配置的更加合理化   </font>
...
>   1、**资源错配，**一定有问题
>
>   2、<font color='red'>有些资源是可以相互转化的·</font>，所以追求cpu、gpu、带宽的<font color='red'>负载均衡</font>
>
>    3、<font color='red'>尽一切可能，少做（减少不必要）</font>



## 性能问题之咸鱼上位（优先级反转问题）

本质：<font color='red'>**资源（优先级）错配**</font>
...
>   GPU合成，向display刷图的数据量就减少了 ---------> 减小了带宽



## 尽一切可能，少做（减少不必要）

weston的damage机制：  没有damage的区域，不再重绘
